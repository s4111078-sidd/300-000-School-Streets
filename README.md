...
|---|---|---|
| **FAS** — Footpath Accessibility Score | Field observation | Footpath presence, width, continuity, and condition |
| **CSS** — Crossing Safety Score | Field observation | Crossing type, distance, visibility, and signals |
| **EEI** — Environmental Exposure Indicator | Field observation | Traffic volume, speed, lighting, and school zone |
| **CYS** — Cycling Safety Score | **Auto-computed from OSM** | Cycling network coverage, protected infrastructure, crossings, and road speed |

Overall score = average of FAS + CSS + EEI + CYS. A score of **6.0 or above** is considered good.
